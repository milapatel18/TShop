...
<div class="navbar navbar-tshop navbar-fixed-top megamenu"
					...
					<div class="pull-right">
						<ul class="userMenu">
							<sec:authorize access="!hasAnyRole('ROLE_ANONYMOUS')">
								...
								<li><ycommerce:testId code="header_LoggedUser">
										<spring:theme code="header.welcome"
											arguments="${user.firstName},${user.lastName}"
											htmlEscape="true" />
									</ycommerce:testId></li>
							...
							<sec:authorize access="hasAnyRole('ROLE_ANONYMOUS')">
								<li class=""><ycommerce:testId code="header_Login_link">
										<a href="<c:url value='/login'/>"> <span class="hidden-xs"><spring:theme
													code="header.link.login" /> <i
												class="glyphicon glyphicon-log-in hide visible-xs "></i> </span>
										</a>
									</ycommerce:testId></li>
							</sec:authorize>
	...
	<div class="container">
		<div class="navbar-header">
			...
			<a class="navbar-brand " href="index.html"> <cms:pageSlot
					position="SiteLogo" var="logo" limit="1">
					<cms:component component="${logo}" class="yComponentWrapper" />
				</cms:pageSlot>
			</a>
