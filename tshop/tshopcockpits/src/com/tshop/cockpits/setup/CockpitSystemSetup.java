 ...
 */
package com.tshop.cockpits.setup;
...
import com.tshop.cockpits.constants.TshopCockpitsConstants;
 ...
 */
@SystemSetup(extension = TshopCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(TshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(TshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						TshopCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/tshopcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
