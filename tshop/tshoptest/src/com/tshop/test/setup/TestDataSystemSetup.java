...
import com.tshop.test.constants.TshopTestConstants;
import com.tshop.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = TshopTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/tshoptest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/tshoptest/import/reviews.impex");
			...
			importImpexFile(context, "/tshoptest/import/cstickets.impex");
		}
	}
}
