 ...
 */
package com.tshop.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(TshopFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(TshopFulfilmentProcessConstants.PARENT_PROCESS);
